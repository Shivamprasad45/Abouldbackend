...
-- CreateEnum
CREATE TYPE "ActivityAction" AS ENUM ('CREATED', 'UPDATED', 'DELETED', 'ASSIGNED', 'STATUS_CHANGED', 'COMMENTED', 'COMMENT_EDITED', 'COMMENT_DELETED');

-- CreateEnum
CREATE TYPE "EntityType" AS ENUM ('TASK', 'COMMENT', 'USER');
